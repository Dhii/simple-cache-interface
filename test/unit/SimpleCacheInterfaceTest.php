...
use Dhii\Cache\SimpleCacheInterface as TestSubject;
use Xpmock\TestCase;
 ...
 * @since [*next-version*]
 */
class SimpleCacheInterfaceTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Cache\SimpleCacheInterface';
